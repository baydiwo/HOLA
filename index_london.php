...
<?php } else {
	while (TRUE){
		...
		$url = "https://api.instagram.com/v1/tags/".$tag."/media/recent?access_token=2988019436.c91b5f8.93fd1389ab174df8a8e6a50711912aed"; // SEARCH BY TAGS - Instagram API tags
		if ($searchByLocation){
