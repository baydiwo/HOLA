...
class USER
{
	...
	public function saveclient($clientname,$orderdate,$hashtag)
	{
		try
		{
			$stmt = $this->conn->prepare("INSERT INTO `order` (clientName,orderdate,hashtag) VALUES(:clientname, :orderdate , :hashtag)");
